...
const messages = defineMessages({
    noLineTerminators: {
        ...
        description:
            "no line terminators in the end of serialsport messge to send",
...
class HardwareConsole extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.peripheralName) {
            this.props.vm.setPeripheralBaudrate(
                this.props.deviceId,
    ...
    onReciveData(data) {
        ...
        if (
            this._recivceBuffer.byteLength + data.byteLength >=
            MAX_CONSOLE_LENGTH
        ) {
            this._recivceBuffer = this._recivceBuffer.slice(
                this._recivceBuffer.byteLength +
                    data.byteLength -
                    MAX_CONSOLE_LENGTH
            );
        }
