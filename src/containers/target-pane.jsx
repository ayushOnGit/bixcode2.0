...
class TargetPane extends React.Component {
    ...
    handleSelectSprite(id) {
        console.log("handleSelectSprite called with id:", id); // Debug log
    ...
    handleSurpriseSpriteClick() {
        ...
        this.props.vm
            ...
            .then(() => {
                console.log("Surprise sprite added:", item); // Debug log
                this.handleActivateBlocksTab();
            })
            .catch((err) => {
                console.error("Error adding surprise sprite:", err); // Debug log
            });
    }
    handlePaintSpriteClick() {
        ...
        this.props.vm
            .addSprite(JSON.stringify(emptyItem))
            .then(() => {
                console.log("Paint sprite added:", emptyItem); // Debug log
                setTimeout(() => {
            ...
            .catch((err) => {
                console.error("Error adding paint sprite:", err); // Debug log
            });
    }
    handleActivateBlocksTab() {
    ...
    handleNewSprite(spriteJSONString) {
        return this.props.vm
            ...
            .then(() => {
                console.log("New sprite added:", spriteJSONString); // Debug log
                this.handleActivateBlocksTab();
            })
            .catch((err) => {
                console.error("Error adding new sprite:", err); // Debug log
            });
    }
    handleFileUploadClick() {
