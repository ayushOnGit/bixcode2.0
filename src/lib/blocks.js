...
export default function (vm) {
    ...
    const spriteMenu = function () {
        ...
        // console.log("sprite gui console:-- ", sprites);
        return sprites;
    };
    ...
    ScratchBlocks.Blocks.sensing_of.init = function () {
        ...
        const menuFn = function () {
            ...
            if (vm.editingTarget) {
                ...
                const stageVariableMenuItems = stageVariableOptions.map(
                ...
                if (target) {
                    spriteVariableOptions =
                        target.getAllVariableNamesInScopeByType("", true);
    ...
    // ScratchBlocks.Arduino['pin_setBoardLed'] = function(block) {
    //     ScratchBlocks.Arduino.includes_['include_servo'] = '#include <modular.h>';
