...
import { closeRecognizeVideoModal } from "../../reducers/modals";
import ml5 from "ml5";
...
const detection_options = {
    ...
    minConfidence: 0.5,
    Mobilenetv1Model:
        "https://ide.tinkergen.com/ai_library/face-api/ssd_mobilenetv1_model-weights_manifest.json",
    FaceLandmarkModel:
        "https://ide.tinkergen.com/ai_library/face-api/face_landmark_68_model-weights_manifest.json",
    FaceLandmark68TinyNet:
        "https://ide.tinkergen.com/ai_library/face-api/face_landmark_68_tiny_model-weights_manifest.json",
    FaceRecognitionModel:
        "https://ide.tinkergen.com/ai_library/face-api/face_recognition_model-weights_manifest.json",
    FaceExpressionModel:
        "https://ide.tinkergen.com/ai_library/face-api/face_expression_model-weights_manifest.json",
    AgeAndGenderModel:
        "https://ide.tinkergen.com/ai_library/face-api/age_gender_model-weights_manifest.json",
...
const modelJson =
    "https://ide.tinkergen.com/ai_library/speech-commands/model.json";
...
class RecognizeVideoModal extends React.Component {
    constructor(props) {
        ...
        this.modelLoadingPrompt = props.intl.formatMessage(
            localMessages.modelLoadingPrompt
        );
    }
    ...
    async initMedia(hasWebcam, hasMicrophone) {
        ...
        if (hasWebcam) {
            ...
            //没有视频，那肯定有音频  No webcam means there will be audio
            constraints = {
                audio: true,
            };
        }
    ...
    async loadSoundModel() {
        if (this.classifier == null) {
            try {
                this.classifier = await ml5.soundClassifier(
                    modelJson,
                    options,
                    this.modelReady
                );
    ...
    render() {
        ...
        const { minimizeState, modelLoading, soundModelLoading } = this.state;
        ...
        return (
            <div
                ...
                style={{
                    ...
                    height: minimizeState ? "56px" : "350px",
                }}
...
export default injectIntl(
    connect(mapStateToProps, mapDispatchToProps)(RecognizeVideoModal)
);
